...
image = (
  bentoml.images.Image(base_image="nvidia/cuda:12.4.1-cudnn-devel-ubuntu22.04", python_version='3.12').run(cmd1).run(cmd2).system_packages('curl', 'git').requirements_file('requirements.txt')
)
